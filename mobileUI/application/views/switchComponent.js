...
export class Switch extends Component {
	static propTypes = {
        ...
        barWidthOffset: PropTypes.number
	};
	...
	constructor(props, context) {
		...
		this.state = {
			...
			transformSwitch: new Animated.Value(
                props.value ?
                props.circleSize / 2 + props.barWidthOffset
                : -props.circleSize / 2 + props.barWidthOffset
            ),
				...
				<Animated.View
					style={[
						...
						{ 
                            ...
                            width: circleSize * 2 + barWidthOffset,
				...
				>
					<Animated.View
						style={[
							...
							{ left: transformSwitch, width: circleSize * 2 + barWidthOffset },
						]}
					>
